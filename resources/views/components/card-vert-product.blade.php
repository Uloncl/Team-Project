<div class="col my-3">
    <div class="card">
        <div class="row">
            <div class="col-sm-3">
                <img class="card-img" src="{{ $product['img-vert'] }}" alt="Image loading error">
            </div>
            ...
            <div class="col-sm-1 row">
                <div class="w-100 my-auto">
                    <a type="button" onclick="<?php echo ($product['name'] = str_replace(' ', '_', $product['name'])) ?>()" href="#" class="text-dark align-right float-end d-inline-block text-center p-2 px-3">
