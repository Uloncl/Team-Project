<x-app>
	<div class="d-flex" style="
		...
		<div class="justify-content-center align-items-center w-100">
			...
			<div class="mb-5 container bg-light rounded">

				<p style="text-align:center; display:inline;">
					Sahara is born from the joint passion of five students for videogames and technology.
					<br>The idea of Sahara is to find a good online catalogue where the users can find what they are looking for
					without problems.
					<br>Our primary goal is to make the user feel safe on our platform. This is a prototype for our University project.
					And we consider it a stepping stone towards more complex goals.
					We strongly hope you will enjoy using this platform.
				</p>
