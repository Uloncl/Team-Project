                ...
                if ($appDetails != null) {
                    ...
                    if ($appDetails['success'] == true) {
                        ...
                        if (isset($appDetails['recommendations']) && $appDetails['recommendations'] > 200 && $appDetails['type'] == 'game') {
                            if (isset($appDetails->release_date->date)) {
                                if (
                                    $appDetails->release_date->date != null     ||
                                    $appDetails->release_date->date != ""       ||
                                    $appDetails->release_date->date != "TBA"    ||
                                    $appDetails->release_date->date != "TBD"    ||
                                    $appDetails->release_date->date != "Coming Soon" ||
                                    count(explode(' ', trim($appDetails->release_date->date, ","))) != 3
                                ) {
                                    $date_str = str_replace(",", "", $appDetails->release_date->date);
                                    ...
                                    $date_f = Carbon::createFromFormat('d/m/Y', $date_str)->format('Y-m-d');
                                }
                            }
                            $gameDBID = DB::table('games')
                                ->insertGetId([
                                    ...
                                    'release_date_f' => isset($date_f) ? $date_f : null,
                                    ...
                                    if (DB::table('games')->where('steam_id', $dlcid)->doesntExist()) {
                                        ...
                                        if ($dlcDetails != null) {
                                            ...
                                            if ($dlcDetails['success'] == true) {
                                                ...
                                                if (isset($dlcDetails->release_date->date)) {
                                                    if (
                                                        $dlcDetails->release_date->date != null     ||
                                                        $dlcDetails->release_date->date != ""       ||
                                                        $dlcDetails->release_date->date != "TBA"    ||
                                                        $dlcDetails->release_date->date != "TBD"    ||
                                                        $dlcDetails->release_date->date != "Coming Soon" ||
                                                        count(explode(' ', trim($dlcDetails->release_date->date, ","))) != 3
                                                    ) {
                                                        $date_str = str_replace(",", "", $dlcDetails->release_date->date);
                                                        $date_arr = explode(' ', $date_str, ",");
                                                        switch ($date_arr[1]) {
                                                            case "Jan":
                                                                $date_arr[1] = "1";
                                                        ...
                                                        $date_str = implode("/", $date_arr);
                                                        $dlc_date_f = Carbon::createFromFormat('d/m/Y', $date_str)->format('Y-m-d');
                                                    }
                                                }
                                                $dlcDBID = DB::table('games')
                                                    ->insertGetId([
                                                        ...
                                                        'release_date_f' => isset($dlc_date_f) ? $dlc_date_f : null,
