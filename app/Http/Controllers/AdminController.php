...
class AdminController extends Controller
{
    ...
    public function update()
    {
        ...
        // $existinggamesinTable = DB::table('games')->where('type', 'game')->where('banned', false)->get(['id', 'steam_id']);
        ...
        //         'appids' => $existinggame->steam_id,
        //         'l' => 'english',
        //         'cc' => 'EE'
        //     ]));
        //     if ($appDetails != null) {
        //         // dd($appDetails);
        //         $appDetails = $appDetails->{$existinggame->steam_id};
        //         if ($appDetails->success == true) {
        //             $appDetails = $appDetails->data;
        //             if (isset($appDetails->packages)) {
        //                 // dd($appDetails);
        //                 foreach ($appDetails->package_groups as $group) {
        //                     // dd($group);
        //                     foreach ($group->subs as $sub) {
        //                         Log::info(var_dump($sub));
        //                         if (DB::table('game_packages')->where('steam_package_id', $sub->packageid)->doesntExist()) {
        //                             DB::table('game_packages')->insert([
        //                                 'game_id' => $existinggame->id,
        //                                 'steam_package_id' => $sub->packageid,
        //                                 'option_text' => $sub->option_text,
        //                                 'option_description' => $sub->option_description,
        //                                 'is_free' => $sub->is_free_license,
